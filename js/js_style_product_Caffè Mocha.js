...
const leg7 = document.getElementById("leg7");
...
const topping_select = ["Topping",
    "Whipped Cream", "Extra Whipped Cream", "Light Whipped Cream", "Extra Whipped Cream"
]

const espresso_select = ["Espresso",
    "Blonde Espresso", "Signature Espresso", "1/2 Decaf", "Decaf Espresso Roast", "1/3 Decaf", "2/3 Decaf"
]
const sizes = {
    short: 2,
    tall: 5,
...
let type_topping = [0, 5, 4, 6, 2];
let type_espresso = [0, 8, 3, 9, 2, 5, 6];
let cost_shot = 1;
let cost_flavor = 3;
let shots = 2;
let flavors = 4;
...
function updatePrice() {
    ...
    if (selectedSize != null && selectedImageIndex != null) {
        ...
        cost = cost + type_topping[select4.selectedIndex] + cost_shot*shots + cost_flavor*flavors + type_espresso[select7.selectedIndex];
    } else {
        cost = 0;
    }
...
function changed4() {
    box4.style.border = "3px solid green";
    leg4.style.color = "green";
    updatePrice(); // Cập nhật giá nếu cần (tùy thuộc vào logic của selecter)
}

function changed7() {
    box7.style.border = "3px solid green";
    leg7.style.color = "green";
    updatePrice();
}
...
function add_order() {
    if (selectedSize == null) {
        ...
        \nKích thước: ${selectedSize.toUpperCase()}, Sữa: ${milk_select[select1.selectedIndex]}, 
        \nSữa: ${roast_select[select2.selectedIndex]}, Sữa: ${hot_select[select3.selectedIndex]},
        \nToppings: ${topping_select[select4.selectedIndex]}, Flavors: ${flavors}, Shots: ${shots},
...
function increaseFlavors() {
    ...
    box5.style.border = "3px solid green";
    leg5.style.color = "green";
...
function increaseShots() {
    ...
    box6.style.border = "3px solid green";
    leg6.style.color = "green";
    updatePrice(); // Cập nhật giá khi số shots thay đổi
}
