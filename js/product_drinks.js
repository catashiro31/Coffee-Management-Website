const products = [
    {
        ...
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true, // Hi?n th? m?c ch?n size
            milk: true,
            roast: true,
            hot: true,
            topping: true,
...

    {
        ...
        calories: 5,
        imageSrc: '../assets/images/duong-241230692/Starbucks® Blonde Roast - Veranda Blend®.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
    {
        ...
        calories: 5,
        imageSrc: '../assets/images/duong-241230692/Medium Roast - Guatemala Casi Cielo®.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
     {
        ...
        calories: 5,
        imageSrc: '../assets/images/duong-241230692/Dark Roast - Caffè Verona®.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
    {
        ...
        calories: 5,
        imageSrc: '../assets/images/duong-241230692/Decaf Roast - Pike Place® Roast.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
    {
        ...
        calories: 370,
        imageSrc: '../assets/images/duong-241230692/Sugar-Free Vanilla Protein Latte.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
...

    {
        ...
        calories: 250,
        imageSrc: '../assets/images/duong-241230692/Starbucks® Blonde Vanilla Latte.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
    {
    ...
    },
     {
        ...
        calories: 120,
        imageSrc: '../assets/images/duong-241230692Pecan Oatmilk Cortado.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
     {
        ...
        calories: 150,
        imageSrc: '../assets/images/duong-241230692/Brown Sugar Oatmilk Cortado.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
     {
        ...
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: false, // Hi?n th? m?c ch?n size
            milk: false,
            roast:false,
            hot: false,
            topping: false,
    ...
    },
     {
        ...
        calories: 190,
        imageSrc: '../assets/images/duong-241230692/Chocolate Cream Protein Cold Brew.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
     {
        ...
        calories: 150,
        imageSrc: '../assets/images/duong-241230692/Vanilla Sweet Cream Cold Brew.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
     {
        ...
        calories: 100,
        imageSrc: '../assets/images/duong-241230692/Nondairy Vanilla Sweet Cream Cold Brew.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
     {
        ...
        calories: 150,
        imageSrc: '../assets/images/duong-241230692/Nondairy Salted Caramel Cream Cold Brew.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
     {
        ...
        calories: 150,
        imageSrc: '../assets/images/duong-241230692/Cold Brew with Nondairy Vanilla Sweet Cream Cold.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
     {
        ...
        calories: 150,
        imageSrc: '../assets/images/duong-241230692/Nondairy Chocolate Cream Cold Brew.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
          sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
     {
        ...
        calories: 10,
        imageSrc: '../assets/images/duong-241230692/Vanilla Sweet Cream Nitro Cold Brew.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
          sizes: true, // Hi?n th? m?c ch?n size
            milk: false, 
    ...
    },
     {
        ...
        calories: 410,
        imageSrc: '../assets/images/duong-241230692/Iced Pecan Crunch Oatmilk Latte.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true, // Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
     {
        ...
        calories: 200,
        imageSrc: '../assets/images/duong-241230692/Iced Sugar-Free Vanilla Protein Latte.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
          sizes: true, // Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
 {
    ...
    },
    {
        ...
        calories: 320,
        imageSrc: '../assets/images/duong-241230692/Matcha Crème Frappuccino® Blended Beverage.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true,// Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
    {
        ...
        calories: 140,
        imageSrc: '../assets/images/duong-241230692/Strawberry Açaí Lemonade Refresher.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true,// Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
    {
        ...
        calories: 140,
        imageSrc: '../assets/images/duong-241230692/Mango Dragonfruit Lemonade Refresher.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: true,// Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
    {
        ...
        calories: 420,
        imageSrc: '../assets/images/duong-241230692/Caramel Ribbon Crunch Frappuccino® Blended Beverage.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true,// Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
    {
        ...
        calories: 420,
        imageSrc: '../assets/images/duong-241230692/Pumpkin Spice Frappuccino® Blended Beverage.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true,// Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
     {
        ...
        calories: 420,
        imageSrc: '../assets/images/duong-241230692/Brown Sugar Strato™ Frappuccino® Blended Beverage.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true,// Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
     {
        ...
        calories: 420,
        imageSrc: '../assets/images/duong-241230692/Strawberry Matcha Strato™ Frappuccino® Blended Beverage.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
            sizes: true,// Hi?n th? m?c ch?n size
            milk: true,
    ...
    },
    {
        ...
        calories: 150,
        imageSrc: '../assets/images/duong-241230692/Spindrift® Lemon Sparkling Water.jpg',
        // Đ?nh nghia CÁC TÙY CH?NH (customizers) có s?n cho s?n ph?m này
        customizers: {
           sizes: false,// Hi?n th? m?c ch?n size
            milk: false,
    ...
    },
    {
        ...
        calories: 5,
        imageSrc: '../assets/images/duong-241230692/cold-brew.jpg', // (B?n c?n có ?nh này)
        // S?n ph?m này CH? CÓ size, KHÔNG có các tùy ch?n khác
        customizers: {
            sizes: true,
            milk: false, // ?n m?c ch?n s?a
            roast: false,
            hot: false,
            topping: false,
            flavors: true, // Hi?n th? m?c ch?n flavors
            shots: true,
            espresso: false,
        }
    }
    // Thêm các s?n ph?m khác vào dây...
];

/* ==============================================
   2. CÁC BI?N VÀ HÀM HELPER
   ============================================== */

// Helpers d? l?y URL param
const getParam = (key) => new URL(window.location.href).searchParams.get(key);

// Helpers d? ch?n s?n ph?m
function pickProduct() {
  const pid = getParam('id') || 'caffe-mocha'; // M?c d?nh là 'caffe-mocha'
  return products.find((p) => p.id === pid) || products[0];
}

// Helper t?o ph?n t? (r?t h?u ích)
...
const topping_select = ["Topping (Phụ)", "Kem tươi (Whipped Cream)", "Nhiều kem tươi", "Ít kem tươi", "Không kem"];
